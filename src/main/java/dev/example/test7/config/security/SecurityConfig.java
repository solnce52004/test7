...
import dev.example.test7.config.security.jwt.JwtConfigurer;
...
@Configuration
@EnableWebSecurity
@EnableGlobalMethodSecurity(prePostEnabled = true)// теперь доступы прописываются над методами
...
//                .username("user")
//                .password(passwordEncoder().encode("user"))//SimpleGrantedAuthorities by "reader"
